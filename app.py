...
# دالة التنسيق الـ CSS لتوسيط العناصر وجعل الصورة تمتد على كامل الشاشة مع إنزال العنوان
st.markdown("<style> html, body, [data-testid='stMarkdownContainer'], h1, h2, h3, p, button, label { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif !important; } .block-container { padding-top: 1rem !important; padding-bottom: 1rem !important; padding-left: 0rem !important; padding-right: 0rem !important; max-width: 100% !important; } .stButton>button { background-color: #e75480; color: white; border-radius: 20px; padding: 12px 30px; font-size: 18px; border: none; width: 300px; font-weight: bold; display: block; margin: 0 auto !important; } .stButton>button:hover { background-color: #c93d6a; color: white; } h1 { color: #c93d6a; text-align: center; font-weight: 800; font-size: 42px !important; margin-bottom: 10px; } [data-testid='stImage'] img { width: 100vw !important; max-width: 100vw !important; height: auto !important; object-fit: cover !important; display: block; margin: 0 !important; padding: 0 !important; } [data-testid='stImage'] { width: 100% !important; display: flex !important; justify-content: center !important; } .butterfly-quote { text-align: center; font-style: italic; color: #ffffff !important; background-color: #e75480; padding: 15px; border-radius: 15px; font-size: 18px; font-weight: 500; box-shadow: 0px 4px 10px rgba(0,0,0,0.05); max-width: 600px; margin: 0 auto; } .centered-content { max-width: 700px; margin: 0 auto; padding: 20px; } </style>", unsafe_allow_html=True)
...
# --- الواجهة الأولى (Page 1): العنوان نازل لأسفل قليلاً والصورة ملء الشاشة ---
if st.session_state.page == 1:
    # أضفنا أسطر فارغة إضافية هنا لإنزال العنوان لأسفل بناءً على طلبكم
