...
# دالة التنسيق الـ CSS لتوسيط العناصر وجعل الصورة تمتد على كامل الشاشة
...
# --- الواجهة الأولى (Page 1): العنوان فوق والصورة الممتدة على كامل واجهة الحاسبة ---
if st.session_state.page == 1:
    st.markdown("<br>", unsafe_allow_html=True)
    st.title("Engineering Titans")
    st.markdown("<br>", unsafe_allow_html=True)
    
    # عرض صورتكم المرفوعة لتأخذ كامل عرض شاشة الحاسبة تلقائياً
